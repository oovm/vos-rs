...
impl Default for Project {
    fn default() -> Self {
        Self {
            ...
            edition: Version { major: 2020, minor: 0, patch: 0, pre: Default::default(), build: Default::default() },
            version: Version { major: 0, minor: 0, patch: 0, pre: Default::default(), build: Default::default() },
